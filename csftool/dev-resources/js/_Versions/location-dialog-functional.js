...
CsfToolLocationDialog.prototype.initDefaultState = function() {
    return { contentAnchor:"#csftool-location-dialog-content",
             centerAnchor:"#csftool-content",
             ...
             lat:42.45, lon:-76.48, name:"default" }
}
...
CsfToolLocationDialog.prototype.createDialogInstance = function(dom_element) {
    ...
    console.log("dialogAnchor : " + this.contentAnchor);
