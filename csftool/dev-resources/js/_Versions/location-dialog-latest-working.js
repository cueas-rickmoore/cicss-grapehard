...
function CsfToolLocationDialog() {
    var anchor, anchors, dimensions, locations, options, supported_events, title;
    this.anchor = null;
...
CsfToolLocationDialog.prototype.createDialogInstance = function(dom_element) {
    ...
    //if (loc.name) { jQuery("#csftool-location-name").val(loc.name); }
    //if (loc.description) { jQuery("#csftool-location-address").val(loc.description); }
    //if (loc.lat) { jQuery("#csftool-location-lat").val(loc.lat); }
    //if (loc.lon) { jQuery("#csftool-location-lon").val(loc.lon); }
    return this;
}
...
CsfToolLocationDialog.prototype.dialogButtons = function() { 
    ...
    return { Cancel: { "class": "csftool-location-dialog-cancel", text:"Cancel",
                       click: function () {
                           ...
                           jQuery(this).executeCallback("cancel");
                       }
             },
             Delete: { "class": "csftool-location-dialog-delete", text:"Delete",
                       click: function () {
                           console.log("DELETE button clicked");
                           jQuery(this).executeCallback("delete");
                       }
             },
             Save: { "class": "csftool-location-dialog-save", text:"Save",
                     click: function () {
                         ...
                         _this.executeCallback("save");
                         if (_this.locationChanged()) { this.executeCallback("changed"); }
                     }
             }
    }
}
